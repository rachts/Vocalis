  ...
  return (
    <AnimatePresence>
      <motion.aside 
        ...
        className="hidden lg:flex w-80 glass-panel rounded-xl flex-col h-full shadow-2xl relative overflow-hidden"
      >
        ...
        <div className="p-6 flex-1 overflow-y-auto">
          ...
          <p className="font-mono-data text-mono-data text-on-surface-variant mb-6">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-white/5 rounded-full font-body-sm text-body-sm text-on-surface-variant border border-white/5 flex items-center gap-1">
                  <span className="material-symbols-outlined text-[14px]">link</span> Generated UI
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="p-4 border-t border-white/5 bg-surface-container/50 flex justify-between gap-2">
          ...
          <button className="w-10 flex items-center justify-center rounded-lg bg-error-container/10 text-error hover:bg-error-container/20 transition-colors border border-error/10">
